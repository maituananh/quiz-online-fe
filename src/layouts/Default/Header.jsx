    ...
    <div className="bg-white shadow-sm sticky top-0 z-10">
      <div className="container mx-auto px-4">
        <div className="flex overflow-x-auto space-x-6 text-blue-600">
          ...
          <NavLink className="flex items-center" to={routers.managementQuiz}>
            <FontAwesomeIcon
              icon={faEdit}
          ...
          <NavLink className="flex items-center" to={routers.creationTopic}>
            <FontAwesomeIcon
              icon={faFolder}
              className="tab-btn px-2 py-4 text-sm font-medium whitespace-nowrap focus:outline-none"
            />
          ...
          <NavLink className="flex items-center" to={routers.testing}>
            <FontAwesomeIcon
              icon={faPlayCircle}
              className="tab-btn px-6 py-4 text-sm font-medium whitespace-nowrap focus:outline-none"
            />
            <p>Test Topic</p>
          </NavLink>
        </div>
